            ...
            <div class="col-sm-12">
                <div class="panel">
                    <div class="panel-content">
                        <h4 class="content_title">About Us <a class="edit_content" href="#" ><i class="fa fa-edit"></i></a></h4>  
                        <?php echo display_message_info([1 => $success, 2 => $error, 3 => validation_errors()]); ?>
                        <?php echo form_open("about", ["id" => "about-us"]); ?>
                        <textarea name="about_text"  style="width:100%" id="about_text" disabled="disabled"><?php echo $items->about_text; ?></textarea>
