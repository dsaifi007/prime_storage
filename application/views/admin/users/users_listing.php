                                    ...
                                    if (count($items) && isset($items)) {
                                        ...
                                        foreach ($items as $value) {
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <label class="switch">
                                                        <input type="checkbox" name="check" id="check" value="0"  user-id = "<?php echo $value->id; ?>" <?php echo $is_blocked; ?>>
                                                        <span class="slider round"></span>
                                                    </label>
                                                </td>
                                                <td><a href="<?php echo base_url("user-detail/$value->id"); ?>" class="green-btn"><i class="fa fa-eye"></i></a></td>
                                            </tr>
                                            <?php
                                            $i++;
                                        }
