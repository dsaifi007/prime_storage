...
class Home extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $data['step'] = 1;
        $data['main_content'] = 'sitelink/home';
        $this->load->view('sitelink/layout', $data);
    }
    ...
    function step_three()
    {
        ...
        $data['step'] = 3;
        $data['main_content'] = 'sitelink/step_three';
        $this->load->view('sitelink/layout', $data);
    }
    ...
    function step_four()
    {
        ...
        $data['main_content'] = 'sitelink/step_four';
        $this->load->view('sitelink/layout', $data);
    }
    // for find_tenantList
